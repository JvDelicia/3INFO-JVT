        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cpf = table.Column<string>(nullable: true),
                    DueDt = table.Column<DateTime>(nullable: false),
                    ItemMenuId = table.Column<int>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Func_ItemMenu_ItemMenuId",
                        column: x => x.ItemMenuId,
                        principalTable: "ItemMenu",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ItemMenuId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    Type = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menu_ItemMenu_ItemMenuId",
                        column: x => x.ItemMenuId,
                        principalTable: "ItemMenu",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Product_ItemMenu_ItemMenuId",
                        column: x => x.ItemMenuId,
                        principalTable: "ItemMenu",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
