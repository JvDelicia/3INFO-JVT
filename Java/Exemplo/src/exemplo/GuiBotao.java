    ...
    private void definirEventos() {
       btMensagem.addActionListener(new ActionListener() {
        ...
        btTeimoso.addMouseListener(new MouseListener() {
            public void mouseClicked(MouseEvent e) { JOptionPane.showMessageDialog(null,"Botão Teimoso!");}
            public void mousePressed(MouseEvent e) { JOptionPane.showMessageDialog(null,"Botão Teimoso!");}
